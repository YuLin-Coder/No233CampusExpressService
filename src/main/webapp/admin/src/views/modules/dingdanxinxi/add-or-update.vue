          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="运费险" prop="yunfeixian">
          <el-select v-model="ruleForm.yunfeixian" placeholder="请选择运费险">
            <el-option
                v-for="(item,index) in yunfeixianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.yunfeixianOptions = "是,否".split(',')
                                                                                  },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
