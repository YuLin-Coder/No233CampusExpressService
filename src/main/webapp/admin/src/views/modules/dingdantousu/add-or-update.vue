          ...
          <el-form-item class="input" label="运费险" prop="yunfeixian">
              <el-input v-model="ruleForm.yunfeixian" 
                placeholder="运费险" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="派发状态" prop="paifazhuangtai">
          <el-input v-model="ruleForm.paifazhuangtai" 
              placeholder="派发状态" clearable ></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `dingdantousu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.dingdantousuCrossAddOrUpdateFlag = false;
                  this.parent.search();
