<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递编号" prop="kuaidibianhao">
          <el-input v-model="ruleForm.kuaidibianhao" 
              placeholder="快递编号" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递编号" prop="kuaidibianhao">
              <el-input v-model="ruleForm.kuaidibianhao" 
                placeholder="快递编号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="数量" prop="shuliang">
              <el-input v-model="ruleForm.shuliang" 
                placeholder="数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运费险" prop="yunfeixian">
          <el-input v-model="ruleForm.yunfeixian" 
              placeholder="运费险" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运费险" prop="yunfeixian">
              <el-input v-model="ruleForm.yunfeixian" 
                placeholder="运费险" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="派发状态" prop="paifazhuangtai">
          <el-select v-model="ruleForm.paifazhuangtai" placeholder="请选择派发状态">
            <el-option
                v-for="(item,index) in paifazhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="派发状态" prop="paifazhuangtai">
	      <el-input v-model="ruleForm.paifazhuangtai"
                placeholder="派发状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="状态更新" prop="zhuangtaigengxin">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhuangtaigengxin" 
                type="datetime"
                placeholder="状态更新">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhuangtaigengxin" label="状态更新" prop="zhuangtaigengxin">
              <el-input v-model="ruleForm.zhuangtaigengxin" 
                placeholder="状态更新" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="大学" prop="daxue">
          <el-input v-model="ruleForm.daxue" 
              placeholder="大学" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="大学" prop="daxue">
              <el-input v-model="ruleForm.daxue" 
                placeholder="大学" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="楼层" prop="louceng">
              <el-input v-model="ruleForm.louceng" 
                placeholder="楼层" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递费用" prop="kuaidifeiyong">
          <el-input v-model="ruleForm.kuaidifeiyong" 
              placeholder="快递费用" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递费用" prop="kuaidifeiyong">
              <el-input v-model="ruleForm.kuaidifeiyong" 
                placeholder="快递费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递员工号" prop="kuaidiyuangonghao">
          <el-input v-model="ruleForm.kuaidiyuangonghao" 
              placeholder="快递员工号" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递员工号" prop="kuaidiyuangonghao">
              <el-input v-model="ruleForm.kuaidiyuangonghao" 
                placeholder="快递员工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递员姓名" prop="kuaidiyuanxingming">
          <el-input v-model="ruleForm.kuaidiyuanxingming" 
              placeholder="快递员姓名" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递员姓名" prop="kuaidiyuanxingming">
              <el-input v-model="ruleForm.kuaidiyuanxingming" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="快递公司" prop="kuaidigongsi">
          <el-input v-model="ruleForm.kuaidigongsi" 
              placeholder="快递公司" clearable ></el-input>
        </el-form-item>
        <div v-else>
    ...
    return {
      ...
      type: '',
            ruleForm: {
                  ...
                  paifazhuangtai: [
                            { required: true, message: '派发状态不能为空', trigger: 'blur' },
                                    	                                                              ],
                  zhuangtaigengxin: [
                                    	                                                              ],
                  xuehao: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='kuaidibianhao'){
            this.ruleForm.kuaidibianhao = obj[o];
            continue;
          }
            ...
            continue;
                    ...
                    if(o=='yunfeixian'){
            this.ruleForm.yunfeixian = obj[o];
            continue;
          }
                    if(o=='paifazhuangtai'){
            this.ruleForm.paifazhuangtai = obj[o];
            continue;
          }
                    if(o=='zhuangtaigengxin'){
            this.ruleForm.zhuangtaigengxin = obj[o];
            continue;
          }
                    if(o=='xuehao'){
            ...
            continue;
                    ...
                    if(o=='kuaidifeiyong'){
            this.ruleForm.kuaidifeiyong = obj[o];
            continue;
          }
                    if(o=='kuaidiyuangonghao'){
            this.ruleForm.kuaidiyuangonghao = obj[o];
            continue;
          }
                    if(o=='kuaidiyuanxingming'){
            this.ruleForm.kuaidiyuanxingming = obj[o];
            continue;
          }
                    if(o=='nianling'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
                                                                                                                                                                                                                                                                                                                                                        this.ruleForm.kuaidiyuangonghao = json.kuaidiyuangonghao
                                                this.ruleForm.kuaidiyuanxingming = json.kuaidiyuanxingming
                                                this.ruleForm.nianling = json.nianling
                                                this.ruleForm.lianxidianhua = json.lianxidianhua
                                                this.ruleForm.kuaidigongsi = json.kuaidigongsi
                                                                          } else {
