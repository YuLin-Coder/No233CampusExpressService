      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="入职时间" prop="ruzhishijian">
          <el-input v-model="ruleForm.ruzhishijian" 
              placeholder="入职时间" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入职时间" prop="ruzhishijian">
              <el-input v-model="ruleForm.ruzhishijian" 
                placeholder="入职时间" readonly></el-input>
                                                                                                                                                                    ...
                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="个人履历" prop="gerenlvli">
                <el-input
                	        ...
                	        kuaidiyuangonghao: '',
	                        	        ...
	                        	        gerenlvli: '',
                                                                  ...
                                                                  xingbieOptions: [],
                                                                                                                      rules: {
                  kuaidiyuangonghao: [
                            { required: true, message: '快递员工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
