  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="运费险" prop="yunfeixian">
              <el-input v-model="ruleForm.yunfeixian" 
                placeholder="运费险" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="快递状态" prop="kuaidizhuangtai">
          <el-input v-model="ruleForm.kuaidizhuangtai" 
              placeholder="快递状态" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="快递状态" prop="kuaidizhuangtai">
              <el-input v-model="ruleForm.kuaidizhuangtai" 
          ...
          <el-form-item class="input" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
                placeholder="备注" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="快递员工号" prop="kuaidiyuangonghao">
          <el-select  @change="kuaidiyuangonghaoChange" v-model="ruleForm.kuaidiyuangonghao" placeholder="请选择快递员工号">
            <el-option
                v-for="(item,index) in kuaidiyuangonghaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.kuaidiyuangonghao" label="快递员工号" prop="kuaidiyuangonghao">
...
export default {
  ...
  methods: {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                                                                      ...
                                                                                                                                                                      this.$http({
              url: `option/kuaidiyuan/kuaidiyuangonghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.kuaidiyuangonghaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
                ...
                this.ruleForm.shouji = data.data.shouji
                                                ...
                                                if(data.data.daxue){
                this.ruleForm.daxue = data.data.daxue
              }
                                                if(data.data.banji){
                ...
                this.ruleForm.louceng = data.data.louceng
                                                                                            ...
                                                                                            if(data.data.kuaidiyuanxingming){
                this.ruleForm.kuaidiyuanxingming = data.data.kuaidiyuanxingming
              }
          ...
          this.$message.error(data.msg);
                                                                        ...
                                                                        // 下二随
    kuaidiyuangonghaoChange () {
      this.$http({
        url: `follow/kuaidiyuan/kuaidiyuangonghao?columnValue=`+ this.ruleForm.kuaidiyuangonghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.xueshengxingming){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `quhuoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.quhuoxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
